...
public class CFTCheckInResult extends CFTMethodResult implements KvmSerializable
{
    ...
    public CFTCheckInResult ()
    {
    }

    public CFTCheckInResult (java.lang.Object paramObj,CFTExtendedSoapSerializationEnvelope __envelope)
    {
